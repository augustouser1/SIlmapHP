@extends('layout')
 ...
 <label for=" pergunta"> <h3 > <strong>Qual o nome da espada que foi forjada em Gondolin na primeira era, feita para o rei Turgon, e utilizada por Gandalf posteriormente</strong > </h3 > </label>
